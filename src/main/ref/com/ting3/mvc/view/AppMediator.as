package com.ting3.mvc.view
{
    ...
    import com.ting3.component.lookAndFeel.MusicLookAndFeel;
    import com.ting3.mvc.Signal;
    import com.ting3.mvc.view.listWin.ListWindowMediator;
    import com.ting3.mvc.view.lyricWin.LyricWindowMediator;
    import com.ting3.mvc.view.miniWin.MiniWindowMediator;
    import com.ting3.mvc.view.playerWin.PlayerWindowMediator;
	...
	private function onSelectSkin(e:ContextMenuEvent):void{
	    ...
	    this.sendNotification(Signal.APP_SET_SKIN, item.caption);
	}
	
	override public function listNotificationInterests() : Array {
	    return [Signal.APP_SKIN_LOADED,
		Signal.APP_SWITCH_MINIMODE];
	}
	...
	override public function handleNotification(note:INotification) : void {
		...
		updateAllUI();
		break;
		case Signal.APP_SWITCH_MINIMODE:
